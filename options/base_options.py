...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--loadSize', type=int, default=128, help='scale images to this size')
        ...
        parser.add_argument('--checkpoints_dir', type=str, default='./aoi/2', help='models are saved here')
